...
(function (umscene) {
	...
	function resize() {
		var canvas = document.getElementById('canvas2'),
			mainview = document.getElementById('canvas2');
	...
	function init() {
		...
		gl.clearColor(0.25, 0.25, 0.25, 0.2);
...
*/
		...
		var sdfcanvas = document.getElementById('canvas');
		canvas.addEventListener('mousedown', function (evt) {
			...
			var new_e = new evt.constructor(evt.type, evt);
			sdfcanvas.dispatchEvent(new_e);
			new_e = null;
		});
