...
(function (ummath) {
	...
	UMCurve = function (gl, positions, normals, colors) {
		this.gl = gl;
		this.material_list = [];
	...
	UMCurve.prototype.update = function (positions, normals, colors) {
		var gl = this.gl;
	...
	UMCurve.prototype.dispose = function () {
		var gl = this.gl;
	...
	UMCurve.prototype.init_attrib = function (shader) {
		var gl = this.gl,
			position_attr,
			normal_attr,
			uv_attr;
	...
	UMCurve.prototype.draw = function (shader, camera) {
		var i,
			gl = this.gl,
			index_count,
			index_offset = 0,
	...
	UMCurve.prototype.reset_shader_location = function () {
		var i;
		this.global_matrix_location_ = null;
		for (i = 0; i < this.material_list.length; i = i + 1) {
	...
	UMCurve.prototype.update_box = function () {
		var i,
			vlen;
	...
	window.umpoint = {};
	window.umpoint.UMCurve = UMCurve;
